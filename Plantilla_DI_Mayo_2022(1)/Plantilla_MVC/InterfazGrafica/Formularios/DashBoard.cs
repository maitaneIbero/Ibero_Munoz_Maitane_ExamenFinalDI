...
namespace InterfazGrafica.Formularios
{
    public partial class DashBoard : Form
    {
        ...
        private void but_Clientes_Click(object sender, EventArgs e)
        {
            ...
            panel_BaseDashboard.Controls.Add(clientesUC);
        ...
        private void but_Resumen_Click(object sender, EventArgs e)
        {
            ...
            listaPedido = ControladorBLL.ListarPedidosCliente(this.clientesUC.IDClienteSeleccionado);
            
            resumenUC = new ResumenUC(listaPedido);
